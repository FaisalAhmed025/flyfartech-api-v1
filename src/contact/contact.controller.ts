import { Controller, Get, Post, Body, Patch, Param, Delete, UseInterceptors, UploadedFiles, Req, Res, HttpStatus, ParseFilePipeBuilder } from '@nestjs/common';
...
export class ContactController {
  ...
  @Res() res: Response){
    ...
    if (file.Attachment && file.Attachment.length > 0) {
      Attachment = await this.s3service.Addpdf(file.Attachment[0]);
    }
    const contact  = new Contact()
    contact.imagelink =Attachment
    contact.Name = Name
